...
class PageWrapper extends React.PureComponent<
  PageWrapperReduxProps & PageWrapperComponentProps & RouteComponentProps<void, void>,
  {
    creatingApp: boolean
  }
> {
  ...
  signedOutSecondaryActions() {
    return [
      <AkGlobalItem size="small" href="/rest/auth/login">
        <AkAvatar size="small" />
      </AkGlobalItem>,
    ]
  }
      ...
      <div className={styles.pageWrapper}>
        ...
        <div className={styles.pageContainer}>
          <AkBanner appearance="error" isOpen={this.props.hasPendingMigration}>
            Your Nucleus instance has pending migrations and won't be able to create or modify releases until migrations have been run, admins can run migrations by visiting{" "}
